    ...
    <div className="max-w-4xl mx-auto p-6 bg-card rounded-md shadow-md mt-6 text-pagetext1">
      ...
      <form onSubmit={(e) => e.preventDefault()}>
        <p className="font-text1 mb-6 text-sm">
          Enter source ip, with a netmask, and which ports should be opened for
          that source ip. Please note IPv6 is currently not supported. Ports not
          listed in the table below will be blocked. HTTPS needs to be open to
