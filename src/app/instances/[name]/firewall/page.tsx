...
export default function FirewallPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-md shadow-md mt-6 text-pagetext1">
      <h1 className="font-heading1 text-2xl mb-10">Firewall Settings</h1>
                ...
                <div className="col-span-3">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button 
                      ...
                      className="font-heading1 bg-gray-300 text-pagetext1 text-xs h-9 px-2 rounded hover:opacity-80 cursor-pointer"
                    >
                      Drop
                    </button>
                  </div>
